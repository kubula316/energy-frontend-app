...
export const ThemeToggle = ({ currentTheme, onThemeChange }: ThemeToggleProps) => {
  const buttonBaseClass = "min-w-[44px] px-3 py-1.5 rounded-md text-sm font-medium transition-all duration-200 whitespace-nowrap";
    ...
    <div className="flex items-center gap-2">
      ...
      <div className="flex gap-1">
        ...
        >
          ...
          <span className="hidden md:inline">☀️ Light</span>
        </button>
        <button
